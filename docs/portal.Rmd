...
<!-- Explorez les candidats potentiels afin d'être une clé primaire. Ensuite, ajoutez les clés primaires à chaque table. -->
...
<!-- Explorez les candidats potentiels afin d'être une clé étrangère. Ensuite, ajoutez les clés étrangères à chaque table. -->
...
<!--% Définissez une couleur pour chaque table. Le vert pour la table plots. L'orange pour la table species et le rouge pour la table surveys. Réalisez ensuite un graphique montrant les clés entre les tables..-->

```{r draw}
rodent_dm3 <- ___(___, green = ___, orange = ___, red = ___)
# Graphique 
...
<!-- Le tableau que vous avez obtenu nommé `rodent_sum` doit être remanié afin d'obtenir un tableau avec chaque ligne correspond à une station et chaque colonne à une espèce. -->
...
<!--% Calculez une matrice de distance basée sur le nombre d'individus de chaque espèce par station. Nommez cet objet `dist`. Nous souhaitons donner plus d'importance aux espèces les plus présentes. Choississez l'indice pertinent. -->
...
<!-- Réalisez un mds métrique ou non métrique. Définissez le type de mds à réaliser. Si cela se justifie, réalisé un graphique de Shepard.  -->

```{r}
# mds ---- 
rodent_mds <- mds$___(dist)

# Qualité du mds ----
___(___)

# Graphique de shepard ----
#sh <- shepard(dist, rodent_mds)
#chart(sh) +
...
<!--% Réalisez le graphique associé à votre mds. Ajoutez les types de traitements appliqués grâce à la couleur.  -->
